...
$string['code:enrol:error'] = 'Der Zugangscode hat nicht funktioniert. Bitte versuchen Sie es erneut.';
...
$string['settings:link_user_nav_help'] = 'Legt fest, ob ein Link zur Eingabe eines Codes im Nutzermenü gezeigt wird.';
